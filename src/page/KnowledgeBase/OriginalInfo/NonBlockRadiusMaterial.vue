    ...
    <div class="Xralayout-main">
      ...
      <div class="Xratable">
        ...
        >
          ...
          <el-table-column prop="dateUnit" label="单位" :formatter="formatDate"> </el-table-column>
          <el-table-column prop="shorthand" label="简写" :formatter="formatDate"> </el-table-column>
...
export default {
  ...
  methods: {
    ...
    gettablelist(code) {
      ...
      Api.getUnsealedradionuclide(params)
        .then(res => {
       if (res.code === 0) {
